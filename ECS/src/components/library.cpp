...
drawable::drawable() {}
drawable::drawable(float nw, float nh, unsigned char nr, unsigned char ng, unsigned char nb, unsigned char na)
...
collider::collider() {}
collider::collider(float nw, float nh, float ox, float oy, bool trig)
    : w(nw), h(nh), offset_x(ox), offset_y(oy), is_trigger(trig) {}
...
public:
    ...
    void create_drawable(registry& reg, const entity& e, float w, float h,
    ...
    void create_collider(registry& reg, const entity& e, float w, float h,
                        float ox, float oy, bool trigger) override {
