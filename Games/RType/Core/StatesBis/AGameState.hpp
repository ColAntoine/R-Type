...
class AGameState : public IGameState {
    ...
    protected:
        ...
        void set_state_manager(std::shared_ptr<GameStateManager> manager) { _stateManager = manager; }
        void set_ui_registry(std::shared_ptr<registry> uiRegistry) { _uiRegistry = uiRegistry; }
};
